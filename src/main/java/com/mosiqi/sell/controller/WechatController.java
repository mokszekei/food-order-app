...
//@RestController //return Json, won;t redirect
@Controller
...
public class WechatController {
    ...
    public String authorize(@RequestParam("returnUrl") String returnUrl) throws UnsupportedEncodingException {
        // 1、配置
        // 2、调用方法
        String url = "http://mosiqi.natapp1.cc/sell/wechat/userInfo";
        ...
        log.info("[Wechat Authorization] get code, result = {}", redirectUrl);
